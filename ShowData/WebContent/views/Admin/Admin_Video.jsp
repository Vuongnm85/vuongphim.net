...
<head>
<meta charset="utf-8">
<title>VuongPhim.net Admin | Update Video</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="/ShowData/thongke/luotThichSP"><em
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div>
			...
			<div class="tabsChuyen">
				<div class="tab-itemChuyen active">Video Edition</div>
				<div class="tab-itemChuyen">Video List</div>
				<div class="line"></div>
			</div>
				...
				<div class="tab-paneChuyen active">
					<form action="" method="service">
						<div class="row mainForm" style="margin-bottom: 0px;">
							...
							<!-- Start column 4 -->
							<div class="col-4">
								<img src="/ShowData/views/Admin/img/${form.poster}" height="540"
									width="370" style="margin: 20px;">
							</div>
							<!-- end column 4 -->
							<!-- Start column 8 -->
							<div class="col-8">
								...
								<div class="container">
									<div class="row">
										<div class="formHienThi">
											<div
												class=" col-sm-12 col-md-12 well well-sm col-md-offset-0">
												<form action="${url}/index" method="post">
													${message} <br>
													<!-- YoutubeId -->
													<label for="fname">Youtube Id</label> <input
														class="form-control form-control-lg" type="text"
														value="${form.id}" name="id" placeholder="YoutubeId">
													<!--Title-->
													<label for="fname">Title</label> <input
														class="form-control form-control-lg" type="text"
														value="${form.title}" name="title" placeholder="Title">
													<!--Poster-->
													<label for="fname">Poster</label> <input
														class="form-control form-control-lg" type="text"
														value="${form.poster}" name="poster" placeholder="Poster">
													<!--Description-->
													<label for="fname">Description</label> <input
														class="form-control form-control-lg" type="text"
														value="${form.description}" name="desciption"
														placeholder="Description">
													<!--Link-->
													<label for="fname">Link</label> <input
														class="form-control form-control-lg" type="text"
														value="${form.link}" name="desciption" placeholder="Link">
													<!--Views-->
													<label for="fname">Views</label> <input
														class="form-control form-control-lg" type="text"
														value="${form.views}" name="views" placeholder="Views">
													<!-- Role -->
													<input ${form.active?'checked':''} name="active"
														type="radio" value="true">Active <input
														${form.active?'':'checked'} name="active" type="radio"
														value="false">Inactive<br>
													<!-- Start button group -->
													<div class="form-group">
														<button class="btn btn-success" type="submit"
															formaction="/ShowData/youtube/create">Create</button>
														<button class="btn btn-success" type="submit"
															formaction="/ShowData/youtube/update">Update</button>
														<button class="btn btn-success" type="submit"
															formaction="/ShowData/youtube/delete">Delete</button>
														<a href="/ShowData/youtube/index">Reset</a>
													</div>
													<!-- End button group -->
												</form>
											</div>
					...
					<table border="1" style="width: 100%; background-color: #E6E6E6">
						<c:forEach var="item" items="${videos}">
							<tr>
								...
								<td><a href="/ShowData/youtube/edit/${item.id}">Edit</a></td>
							</tr>
						</c:forEach>
					</table>
					<!-- End bảng -->
