			...
			<div class="row">
				...
				<div class="contact-form spad">
					<div class="container">
						...
						${message}
						<form method="post" action="/ShowData/account/change-pass" method="post" role="form">
							<div class="row">
								<div class="col-lg-6 col-md-12">
									<label>Tên người dùng</label> <input type="text" name="username"
										placeholder="Tên người dùng" value = "${sessionScope.user.id}">
								</div>
								<div class="col-lg-6 col-md-12">
									<label>Mật khẩu trước đây</label> <input type="text" name="matkhau"
										placeholder="Mật khẩu cũ" value = "${sessionScope.user.password}">
								</div>
								<div class="col-lg-6 col-md-12">
									<label>Mật khẩu mới</label> <input type="text" name="newpassword"
										placeholder="Mật khẩu mới">
								</div>
								<div class="col-lg-6 col-md-12">
									<label>Xác nhận mật khẩu mới</label> <input type="text" name="password"
		...
		<div class="sidebar">
				...
				<ul class="sidebar__list">
					...
					<div class="card"
						...
						<a href=""><img src="/ShowData/views/Official/img/30ChuaTet.jpg"
							class="card-img-top"
					...
					<div class="card"
						...
						<a href=""><img src="/ShowData/views/Official/img/trangQuynh.jpg"
							class="card-img-top"
							style="height: 250px; width: 175px; margin: auto"
							alt="Ảnh girl xinh"></a>
					...
					<div class="card"
						...
						<a href=""><img src="/ShowData/views/Official/img/phapSuMu.jpg"
							class="card-img-top"
							style="height: 250px; width: 175px; margin: auto"
							alt="Ảnh girl xinh"></a>
					...
					<div class="card"
						...
						<a href=""><img src="/ShowData/views/Official/img/biMatCuaGio.jpg"
							class="card-img-top"
							style="height: 250px; width: 175px; margin: auto"
							alt="Ảnh girl xinh"></a>
