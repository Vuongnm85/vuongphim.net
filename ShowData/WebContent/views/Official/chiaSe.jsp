						...
						<div class="col-lg-12 text-center">
							<div class="breadcrumb__text">
								...
								<div class="breadcrumb__option">
									<a href="./index.html">Trang chủ</a> <span>-Chia sẻ</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="contact-form spad">
						<div class="container">
							...
							<form method="post" action="/ShowData/form.php" role="form">
								<div class="row">
									<div class="col-lg-12 col-md-12">
										<label>Gmail người nhận</label> <input type="text" name="to"
											placeholder="Gmail người nhận">
									</div>
									<div class="col-lg-12 col-md-12">
										<label>Mã phim</label> <input type="text" name="subject"
											placeholder="Thông tin phim" value=${video.id }>
									</div>
									<div class="col-lg-12 col-md-12">
										<label>Thông tin phim</label> <input type="text" name="title"
											placeholder="Thông tin phim" value=${video.description}>
									</div>

									<label>${message}</label>
									<div class="col-lg-12 text-center">
										<button type="submit" class="site-btn">Chia sẻ</button>
									</div>
								</div>
							</form>
						</div>
