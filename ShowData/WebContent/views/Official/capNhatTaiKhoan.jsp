						...
						<div class="col-lg-12 text-center">
							<div class="breadcrumb__text">
								...
								<div class="breadcrumb__option">
									<a href="./index.html">Trang chủ</a> <span>-Cập nhật tài
										khoản</span>
								</div>
							</div>
						</div>
			...
			<div class="row">
				...
				<div class="contact-form spad">
					<div class="container">
						...
						${message}
						<!-- Start form -->
						<form method="post" action="/ShowData/account/edit-profile"
							method="post" role="form">
							<div class="row">
								<div class="col-lg-6 col-md-12">
									<label>Tên người dùng</label> <input type="text" name="id"
										placeholder="Tên người dùng" value="${sessionScope.user.id}">
								</div>
								<div class="col-lg-6 col-md-12">
									<label>Mật khẩu</label> <input type="text" name="password"
										placeholder="Mật khẩu" value="${sessionScope.user.password}">
								</div>
								<div class="col-lg-6 col-md-12">
									<label>Tên đầy đủ</label> <input type="text" name="fullname"
										placeholder="Tên đầy đủ" value="${sessionScope.user.fullname}">
								</div>
								<div class="col-lg-6 col-md-12">
									<label>Địa chỉ email</label> <input type="text" name="email"
