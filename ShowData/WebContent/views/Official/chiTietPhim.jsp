...
<body>
	<%@include file="/views/Official/slider.jsp"%>
	<div class="row main">
		<div class="phan9">
						...
						<div class="col-lg-12 text-center">
							<div class="breadcrumb__text">
								...
								<div class="breadcrumb__option">
									<a href="./index.html">Trang chủ</a> <span>-${item.title }</span>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="contact-form spad">
					<div class="container">
						<iframe width="1060" height="900"
							src="https://www.youtube.com/${item.link}" frameborder="0"
							allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
							allowfullscreen></iframe>
						<a
							href="/ShowData/yeuThich/create?userid=${sessionScope.user.id}&videoid=${item.id}"
