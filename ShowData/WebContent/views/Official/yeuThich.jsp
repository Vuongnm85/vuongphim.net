...
<body>
	...
	<div class="row main">
		<div class="phan9">
			<div class="row">
				<form action="/ShowData/video/trangQuynh">
					<div class="class-card">
						<!-- Featured Section Begin -->
						<section class="featured spad">
							<div class="row">
								<!--Start Phim moi cap nhat-->
								<div class="col-lg-12">
									...
									<div class="featured__controls">
										<ul>
											...
											<li data-filter=".hanhDong">Phim hành động</li>
											<li data-filter=".tinhCam">Phim tình cảm</li>
											<li data-filter=".vienTuong">Phim viễn tưởng</li>
											<li data-filter=".haiHuoc">Phim hài hước</li>
											<li data-filter=".coTrang">Phim cổ trang</li>
											<li data-filter=".tamLy">Phim tâm lý</li>
										</ul>
									</div>
								</div>
								<!--Phim moi cap nhat-->
							...
							<!--Start danh sach phim moi-->
							<div class="row featured__filter">
								<form action="">
									<c:forEach var="item" items="${form}">
										<div class="col-lg-3 col-md-4 col-sm-6 mix coTrang haiHuoc">
											<div class="featured__item">
												<div class="featured__item__pic set-bg"
													data-setbg="/ShowData/views/Official/img/${item.poster }">
													<!-- Ẩn id tại đây -->

													<ul class="featured__item__pic__hover">
														<li><a href="/ShowData/chiTiet/edit/${item.id }"><i
																class="fa fa-eye"></i></a></li>
														<li><a
															href="/ShowData/yeuThich/remove?userid=${sessionScope.user.id}&videoid=${item.id}"><i
																class="fa fa-thumbs-down"></i></a></li>
														<li><a href="/ShowData/mail/edit/${item.id}"><i
																class="fa fa-share"></i></a></li>
													</ul>
												</div>
												<div class="featured__item__text">
													<h6>
														<a href="/ShowData/chiTiet/edit/${item.id }">Lượt xem: ${item.views }</a>
													</h6>
													<h5>
														<a href="/ShowData/chiTiet/edit/${item.id }">${item.title }</a>
													</h5>

													<!-- <a href="/ShowData/yeuThich/remove?userid=${sessionScope.user.id}&videoid=${item.id}" class="btn btn-primary">Bỏ Thích</a> 
														
														
														<a
															href="/ShowData/mail/edit/${item.id}"
							...
							<div class="product__pagination">
								<a href="#"><i class="fa fa-long-arrow-left"></i></a> <a
									href="#">1</a> <a href="#">2</a> <a href="#">3</a> <a href="#"><i
				...
				<ul class="sidebar__list">
					<c:forEach var="item" items="${form}">
						...
						<div class="card"
							...
							<a href=""><img
								src="/ShowData/views/Official/img/${item.poster }"
								class="card-img-top"
							...
							<div class="card-body"
								...
								<a href="#" class="btn btn-primary">Thích</a> <a
									href="/ShowData/mail/edit/${item.id}" class="btn btn-primary">Chia
									sẻ</a>
							</div>
						</div>
						<br>
