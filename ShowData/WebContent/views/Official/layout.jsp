										...
										<div class="featured__item">
											<div class="featured__item__pic set-bg"
												...
												<ul class="featured__item__pic__hover">
													...
													<li><a
														href="/ShowData/yeuThich/create?userid=${sessionScope.user.id}&videoid=${item.id}"><i
											...
											<div class="featured__item__text">
												<h6>
													<a href="/ShowData/chiTiet/edit/${item.id }">Lượt xem:
														${item.views }</a> <input type="hidden" value="${item.id }"
														name="VideoId">
												</h6>
												<h5>${item.title }</h5>
											</div>
				...
				<ul class="sidebar__list">
					...
					<c:forEach var="item" items="${form}">
						...
						<div class="card"
							...
							<a href=""><img
								src="/ShowData/views/bai1/img/${item.poster }"
								class="card-img-top"
							...
							<div class="card-body"
								...
								<a href="/Show/yeuThich/create/${sessionScope.user.fullname}"
									class="btn btn-primary">Thích</a> <a
